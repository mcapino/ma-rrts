...
public class SynchronousJointSpatioTemporalStraightLineDomain implements Domain<JointSpatioTemporalState, JointSpatioTemporalManeuver> {
    ...
    public SynchronousJointSpatioTemporalStraightLineDomain(Box4dRegion bounds, double separation, TimePoint[] initialPoints,
            Collection<SpaceTimeRegion> obstacles, SpatialPoint[] targets, double targetReachedTolerance, double minSpeed,
